...
tau1 = 4
tau2 = 3
L = 1  # number of test path
L_train = 3 #number of training path
'Channel Information'
...
model_path = './params/DNN_trainable_w_v3_L_SNR_tau1_tau2_N1_N2_' + str((L_train,
                                                                         snrdB, tau1, tau2, N1, N2))
######################################################
...
with tf.Session() as sess:
    ...
    sio.savemat('./results/DNN_trainable_sensing_generalize_tau' + str((tau1,
                                                                  tau2)) +
                str(L)+ '.mat',
