...
model_path = './params/DNN_v3_L_SNR_tau1_tau2_N1_N2_' + str((L, snrdB, tau1, tau2, N1, N2))
######################################################
...
with tf.Session() as sess:
    ...
    # sio.savemat('./results/DNN_random_tau' + str((tau1, tau2)) + '.mat',
