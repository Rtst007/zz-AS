...
with tf.Session() as sess:
    bf_gain_iter = sess.run(bf_gain_list, feed_dict=feed_dict_val)
    ...
    plt.show()
    #
    # sio.savemat('./results/bcd_perfectCSI.mat', {'bf_gain_bcd_iterations_all_samples': np.squeeze(bf_gain_iter),
